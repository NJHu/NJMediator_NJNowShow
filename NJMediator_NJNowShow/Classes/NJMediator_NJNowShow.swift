...
fileprivate let kMediator_Target_NameSpace = "NJNowShow"

fileprivate let kMediator_Target = "NJNowShow"
...
extension NJMediator {
    ...
    public func Mediator_NJNowShow_MainController() -> UIViewController? {
        
        let result = self.perform(nameSpace: kMediator_Target_NameSpace, target: kMediator_Target, action: kMediator_Action_NativeFetchLiveShowMainViewController, params: nil, shouldCacheTarget: false)
