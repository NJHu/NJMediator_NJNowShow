#
# Be sure to run `pod lib lint NJMediator_NJNowShow.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of NJMediator_NJNowShow.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'NJMediator_NJNowShow' => ['NJMediator_NJNowShow/Assets/*.png']
  # }
